...
{
    public class CustomOverlay : View
    {
            ...
            base(context)
        {
            ...
            layout.SetMinimumWidth(25);
            layout.SetMinimumHeight(25);
            layout.WeightSum = 0.3f;
        ...
        //    var topTextLayout = new StaticLayout(this.TopText, textPaint, canvas.Width, Android.Text.Layout.Alignment.AlignOpposite, 1.0f, 0.0f, false);
        //    canvas.Save();
